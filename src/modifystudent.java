   ...
   try
        {
            ...
            String stumobno = jTextField7.getText();
            String gen= jTextField8.getText();
            String stubooksissued = jTextField9.getText();
            
             String qry="update tbstudent set stuname='"+stuname+"', stuadd='"+
                    stuadd+"', stustream='"+stustream+"',stusem="+stusem+",sturollno='"+
                    sturollno+"',stumobno='"+stumobno +"',stugen='"+gen +"',stubooksissued="+stubooksissued+" where stuid="+
                    stuid;
            new DB().update(qry);
